...
?>
    ...
    <p class="text-center text-xl md:text-4xl text-[var(--brand-primary)] pt-16 font-bold">Kontakt</p>
    <div class="py-12 px-4">
        
      <div class="grid grid-cols-1 md:grid-cols-3 mb-12 items-stretch">
    
    <div class="flex flex-col justify-center text-center bg-[var(--brand-primary)] min-h-60 p-6">
    ...
    <div class="flex flex-col justify-center text-center bg-[var(--brand-szara)] min-h-60 p-6">
        <h3 class="font-bold text-[var(--brand-secondary)] mb-4 uppercase">Usługi</h3>
        <p class="text-sm text-gray-800">Rejestracja spółek, kadry, płace oraz pełna księgowość.</p>
    </div>

    <div class="flex flex-col justify-center text-center bg-[var(--brand-secondary)] min-h-60 p-6">
        ...
        <div class="border-t border-gray-300 pt-10 flex flex-col items-center text-center">
            ...
            <div class="text-xs text-zinc-600 space-y-2 md:space-y-0 md:space-x-4 flex flex-col md:flex-row">
                ...
                <span class="hidden md:inline pb-4">|</span> <span>
                    Projekt i wykonanie: <a href="https://way-it.pl" target="_blank" class="text-blue-400 hover:text-[var(--brand-primary)] font-medium transition !no-underline">way-IT Łukasz Kufel</a>
                </span>
            </div>
